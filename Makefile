...
USER_APPS = init idle die_stupidly orphan io_test pipe_test lock_test LedyardTestDriver LedyardBridge cvar_test stack_growth_test
#List all user program source files here.  SHould be the same as the previous list, with ".c" added to each file
USER_SRCS = init.c idle.c die_stupidly.c orphan.c io_test.c pipe_test.c lock_test.c LedyardTestDriver.c LedyardBridge.c cvar_test.c stack_growth_test.c

#List the objects to be formed form the user  source files here.  Should be the same as the prvious list, replacing ".c" with ".o"
USER_OBJS = init.o idle.o die_stupidly.o orphan.o io_test.o pipe_test.o lock_test.o LedyardTestDriver.o LedyardBridge.o cvar_test.o stack_growth_test.o
