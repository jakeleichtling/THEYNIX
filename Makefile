...
USER_APPS = init idle die_stupidly orphan theynix_tests/io_test theynix_tests/pipe_test theynix_tests/lock_test theynix_tests/LedyardTestDriver theynix_tests/LedyardBridge theynix_tests/cvar_test theynix_tests/stack_growth_test cs58_tests/bigstack cs58_tests/forktest cs58_tests/torture cs58_tests/zero theynix_tests/fork_oom_test theynix_tests/bad_exec_test theynix_tests/child_chain theynix_tests/exit_subtleties_test theynix_tests/bad_wait_test theynix_tests/brk_test theynix_tests/delay_test theynix_tests/test_trap_math
#List all user program source files here.  SHould be the same as the previous list, with ".c" added to each file
USER_SRCS = init.c idle.c die_stupidly.c orphan.c theynix_tests/io_test.c theynix_tests/pipe_test.c theynix_tests/lock_test.c theynix_tests/LedyardTestDriver.c theynix_tests/LedyardBridge.c theynix_tests/cvar_test.c theynix_tests/stack_growth_test.c cs58_tests/bigstack.c cs58_tests/forktest.c cs58_tests/torture.c cs58_tests/zero.c theynix_tests/fork_oom_test.c theynix_tests/bad_exec_test.c theynix_tests/child_chain.c theynix_tests/exit_subtleties_test.c theynix_tests/bad_wait_test.c theynix_tests/brk_test.c theynix_tests/delay_test.c theynix_tests/test_trap_math.c
#List the objects to be formed form the user  source files here.  Should be the same as the prvious list, replacing ".c" with ".o"
USER_OBJS = init.o idle.o die_stupidly.o orphan.o theynix_tests/io_test.o theynix_tests/pipe_test.o theynix_tests/lock_test.o theynix_tests/LedyardTestDriver.o theynix_tests/LedyardBridge.o theynix_tests/cvar_test.o theynix_tests/stack_growth_test.o cs58_tests/bigstack.o cs58_tests/forktest.o cs58_tests/torture.o cs58_tests/zero.o theynix_tests/fork_oom_test.o theynix_tests/bad_exec_test.o theynix_tests/child_chain.o theynix_tests/exit_subtleties_test.o theynix_tests/bad_wait_test.o theynix_tests/brk_test.o theynix_tests/delay_test.o theynix_tests/test_trap_math.o
